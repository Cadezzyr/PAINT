...
def main():
    ...
    shuffle_list = ['x_shuffle_cifar10.pth']
    shuffle_label_list = ['y_shuffle_cifar10.pth']
    acc = 0
    for i in range(len(shuffle_list)):
        ...
        len_all = len(x_shuffle)/10000
        len_all = int(len_all)
        for i in range(len_all):
            x_test = x_shuffle[i*10000:(i+1)*10000,]
            y_test = y_shuffle[i*10000:(i+1)*10000,]
